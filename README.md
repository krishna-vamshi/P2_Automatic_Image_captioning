...
This repository consists of the solution for the project: Automaic Image Captioning from the udacity Computer Vision Nanodegree. The solutions are uploaded as the HTML files of notebook 2_training and notebook 3_inference and the models_solution python file. 
